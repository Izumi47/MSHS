        ...
        ***********************************-->
        <div class="content-body">
			<div class="container-fluid">
				<form action="php/admins-add-teacher.php" method="POST" id="addTeacherForm">
					<div class="row">
						<div class="col-xl-12">
							<div class="card">
										...
										<div class="col-xl-12 col-lg-8">
											<div class="row">
												...
												<div class="col-xl-6 col-sm-6">
													...
													<div class="mb-3">
														<label class="form-label mb-2 fs-13 label-color font-w500">Birth Date</label>
					...
					<div class="">
						<a href="admins-dashboard.php" class="btn btn-outline-primary me-3" style="color:#E1E1E1E1">Cancel</a>
						<button class="btn btn-primary" type="submit" id="register-button">Add Teacher</button>
					</div>
				</form>	
			</div>
		</div>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<a href="admins-dashboard.php"><button type="button" class="btn btn-primary">Continue</button></a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal fade" id="warningModal">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>Teacher ID already existed!</p>
				</div>
				<div class="modal-footer">
	...
	<script>
		$(document).ready(function () {
			$('#addTeacherForm').submit(function (event) {
				...
				console.log($('#addTeacherForm').serialize()); // Debugging
				$.ajax({
					type: 'POST',
					url: 'php/admins-add-teacher.php',
					data: $('#addTeacherForm').serialize(),
					success: function (response) {
						console.log(response); // Debugging
						if (response.trim() === 'Teacher added successfully!') {
