...
include 'php/admins-user-profile.php'; // Include backend script for student details
?>
        ...
        <div class="dlabnav">
			<div class="dlabnav-scroll">	
				<ul class="metismenu" id="menu">
					<li><a href="admins-dashboard.php">
        ...
        <div class="content-body">
			<div class="container-fluid">
				<form action="php/teachers-edit-student-profile.php" method="POST" id="editTeacherForm">
					...
					<div class="">
						<a href="admins-user-profile.php" class="btn btn-outline-primary me-3" style="color:#E1E1E1E1">Cancel</a>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>User profile edited successfully!</p>
				</div>
				<div class="modal-footer">
					<a href="admins-user-profile.php?id=<?php echo $userData['id']; ?>"><button type="button" class="btn btn-primary">Continue</button></a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal fade" id="warningModal">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>User profile edit was unsuccessfull!</p>
				</div>
				<div class="modal-footer">
    ...
    ***********************************-->
	...
	<script>
		...
		$(document).ready(function () {
			...
			$('#userId').val("<?php echo $_GET['id']; ?>");

			$('#editTeacherForm').submit(function (event) {
				event.preventDefault();
				$.ajax({
					type: 'POST',
					url: 'php/admins-edit-user-profile.php',
