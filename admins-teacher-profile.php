							...
							<div class="card-body">
								<div class="d-flex justify-content-between">
									<div class="user">
										...
										<div>
											<h2 class="mb-0"><?php echo htmlspecialchars($teacherData['name'] ?? 'Name not available'); ?></h2>
											<p class="text-primary font-w600"><?php echo htmlspecialchars($teacherData['position'] ?? 'Position not available'); ?></p>
										</div>
									</div>
								...
								<div class="row mt-2">
									<div class="col-xl-2 col-xxl-6 col-sm-6">
										<ul class="student-details">
											...
											<li>
												<span>ID:</span><h5 class="mb-0"><?php echo htmlspecialchars($teacherData['id'] ?? 'ID not available'); ?></h5>
											</li>
										</ul>
									</div>
									<div class="col-xl-2 col-xxl-6 col-sm-6">
										...
										<ul class="student-details">
											...
											<li>
												<span>Birth Date:</span><h5 class="mb-0"><?php echo htmlspecialchars($teacherData['birthdate'] ?? 'Birth Date not available'); ?></h5>
											</li>
										</ul>
									</div>
									<div class="col-xl-2 col-xxl-6 col-sm-6">
										<ul class="student-details">
											...
											<li>
												<span>Phone:</span><h5 class="mb-0"><?php echo htmlspecialchars($teacherData['contact'] ?? 'Contact not available'); ?></h5>
											</li>
										</ul>
									</div>
									<div class="col-xl-2 col-xxl-6 col-sm-6">
										<ul class="student-details">
											...
											<li>
												<span>Email:</span><h5 class="mb-0"><?php echo htmlspecialchars($teacherData['email'] ?? 'Email not available'); ?></h5>
											</li>
										</ul>
									</div>
								</div>
