								...
								<div class="d-flex justify-content-between">
									<div class="user">
										<div class="user-media">
											<img src="data:image/png;base64,<?php echo base64_encode($userData["picture"]); ?>" alt="" class="avatar avatar-xxl">
										</div>
										<div>
											<h2 class="mb-0"><?php echo htmlspecialchars($userData['name'] ?? 'Name not available'); ?></h2>
											<p class="text-primary font-w600"><?php echo htmlspecialchars($userData['position'] ?? 'Position not available'); ?></p>
										</div>
									</div>
									<div class="dropdown custom-dropdown">
										...
										<div class="dropdown-menu dropdown-menu-end">
											<a class="dropdown-item" href="admins-edit-user-profile.php?id=<?php echo $userData['id']; ?>">Edit Details</a>
										</div>
									</div>
								</div>
								<div class="row mt-2">
									<div class="col-xl-2 col-xxl-6 col-sm-6">
										<ul class="student-details">
											...
											<li>
												<span>ID:</span><h5 class="mb-0"><?php echo htmlspecialchars($userData['id'] ?? 'ID not available'); ?></h5>
											</li>
										</ul>
									</div>
									<div class="col-xl-2 col-xxl-6 col-sm-6">
										...
										<ul class="student-details">
											...
											<li>
												<span>Birth Date:</span><h5 class="mb-0"><?php echo htmlspecialchars($userData['birthdate'] ?? 'Birth Date not available'); ?></h5>
											</li>
										</ul>
									</div>
									<div class="col-xl-2 col-xxl-6 col-sm-6">
										<ul class="student-details">
											...
											<li>
												<span>Phone:</span><h5 class="mb-0"><?php echo htmlspecialchars($userData['contact'] ?? 'Contact not available'); ?></h5>
											</li>
										</ul>
									</div>
									<div class="col-xl-2 col-xxl-6 col-sm-6">
										<ul class="student-details">
											...
											<li>
												<span>Email:</span><h5 class="mb-0"><?php echo htmlspecialchars($userData['email'] ?? 'Email not available'); ?></h5>
											</li>
										</ul>
									</div>
								</div>
	...
	<script>
		...
		$(document).ready(function () {
			...
			$('#editTeacherForm').submit(function (event) {
				...
				$.ajax({
					type: 'POST',
					url: 'php/teachers-edit-profile.php',
					data: $('#editTeacherForm').serialize(),
					success: function (response) {
						console.log(response); // Debugging
						if (response.trim() === 'Teacher record updated successfully!') {
