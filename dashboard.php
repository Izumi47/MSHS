    ...
    <div id="main-wrapper">
									...
									<div class="dropdown-menu dropdown-menu-end pb-0" style="box-shadow: 0px 0px 20px 5px black">
										<div class="card mb-0">
											...
											<div class="card-footer text-center p-3">
												<a href="php/logout.php" class="dropdown-item ai-icon btn btn-primary light">
        ...
        ***********************************-->
        <div class="dlabnav">
			<div class="dlabnav-scroll">	
				...
				<div class="copyright" style="margin-top: 230%;">
        ...
        ***********************************-->
        <!--**********************************
            Content body start
        ***********************************-->
		<div class="content-body" style="min-height: 870px;">
            <!-- row -->
							...
							<div class="card-header pb-0 border-0 flex-wrap">
								<div class="mb-2 mb-sm-0">
									<div class="chart-title mb-3">
										<h2 class="heading">Average Students Performance</h2>	
									</div>
								</div>
								<div class="p-static">
					...
					<div class="col-xl-6">
						<div class="card h-auto">
							<div class="card-header border-0 pb-0 flex-wrap">
								<h4 class="heading mb-3 mb-sm-0">Class Overview</h4>
