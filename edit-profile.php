									...
									<div class="dropdown-menu dropdown-menu-end pb-0" style="box-shadow: 0px 0px 20px 5px black">
										<div class="card mb-0">
											...
											<div class="card-body p-3">
												<a href="profile-2.php" class="dropdown-item ai-icon ">
		...
		<div class="dlabnav">
			<div class="dlabnav-scroll">	
				<ul class="metismenu" id="menu">
					<li><a href="students-2.php">
						<i class="material-symbols-outlined">school</i>
						<span class="nav-text">Students</span>
						</a>
					</li>
				</ul>
				<div class="copyright" style="margin-top: 270%;">
        ...
        <div class="content-body">
			<div class="container-fluid">
				<form action="php/edit-student-2.php" method="POST" id="editStudentForm">
										...
										<div class="col-xl-12 col-lg-8">
											<div class="row">
												<div class="col-xl-6 col-sm-6">
													...
													<div class="input-group mb-3 input-primary">
														<input type="text" class="form-control" id="email" name="email" placeholder="---@mshs.com">
												...
												<div class="col-xl-6 col-sm-6">
													...
													<div class="mb-3">
														...
														<select multiple class="default-select form-control" id="interests" name="interests[]"  placeholder="(Choose one or more)"> <!--Choose one or more-->
													...
													<div class="mb-3">
														...
														<select class="default-select  form-control wide" id="ambition" name="ambition" placeholder="(Choose one)"> <!--Only choose one-->
					...
					<div class="">
						<a href="students-2.php" class="btn btn-outline-primary me-3" style="color:#E1E1E1E1">Cancel</a>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<a href="profile-2.php"><button type="button" class="btn btn-primary">Continue</button></a>
				</div>
			</div>
		</div>
	</div>
	...
	<script>
		...
		$(document).ready(function () {
			...
			$("#editStudentModal .btn-primary").click(function() {
				window.location.href = "profile-2.php"; // Redirect to the profile page or any desired page
			});
		});
	</script>
