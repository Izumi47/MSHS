...
if __name__ == "__main__":
    ...
    print(f"Suitable Class Stream: {predicted_stream_label} ({predicted_stream_numeric})")

    # Output accuracy and precision
    print("Model Accuracy:", model_info['accuracy'])
    print("Model Precision:", model_info['precision'])
