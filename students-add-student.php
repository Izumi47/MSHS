        ...
        ***********************************-->
        <div class="content-body">
			<div class="container-fluid">
				<form action="php/add-student-2.php" method="POST" id="addStudentForm">
					<div class="row">
						<div class="col-xl-12">
							<div class="card">
											...
											<div class="row">
												<div class="col-xl-6 col-sm-6">
													...
													<div class="mb-3">
														...
														<input type="number" class="form-control" id="id" name="id" placeholder="Student ID">
													</div>
					...
					<div class="">
						<a href="students-dashboard.php" class="btn btn-outline-primary me-3" style="color:#E1E1E1E1">Cancel</a>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<a href="students-dashboard.php"><button type="button" class="btn btn-primary">Continue</button></a>
				</div>
			</div>
		</div>
	</div>
	...
	<script>
		$(document).ready(function () {
			$('#addStudentForm').submit(function (event) {
				...
				$.ajax({
					type: 'POST',
					url: 'php/students-add-student.php',
