...
<body>
        ...
        ***********************************-->
        <div class="content-body">
			<div class="container-fluid">
				<form action="php/edit-student-2.php" method="POST" id="editStudentForm">
											...
											<div class="row">
												<div class="col-xl-6 col-sm-6">
													<div class="mb-3">
														...
														<input type="text" class="form-control" id="name" name="name" placeholder="<?php echo htmlspecialchars($studentData['CGPA'] ?? 'CGPA not available'); ?>" required>
													</div>
					...
					<div class="">
						<a href="students-profile.php?id=<?php echo $_SESSION['id'];?>" class="btn btn-outline-primary me-3" style="color:#E1E1E1E1">Cancel</a>
						<button class="btn btn-primary" type="submit" id="edit-button">Submit Edit</button> <!--Send to add-student.php-->
					</div>
				</form>	
			</div>
		</div>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>Profile editted successfully!</p>
				</div>
				<div class="modal-footer">
					<a href="students-profile.php"><button type="button" class="btn btn-primary">Continue</button></a>
				</div>
			</div>
		</div>
	</div>

	<!--Profile Edit Unsuccessful-->
	<div class="modal fade" id="warningModal">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>Profile edit was unsuccessfull!</p>
				</div>
				<div class="modal-footer">
    ...
    ***********************************-->
	...
	<script>
		// Modify your document.ready function as follows:
		$(document).ready(function () {
			// Set user ID in hidden input
			$('#userId').val("<?php echo $_SESSION['id']; ?>");

			$('#editStudentForm').submit(function (event) {
				event.preventDefault();
				$.ajax({
					type: 'POST',
					url: 'php/students-edit-profile.php',
			...
			// Add click event listener for the "Continue" button in the modal
			$("#editStudentModal .btn-primary").click(function() {
				window.location.href = "students-profile.php"; // Redirect to the profile page or any desired page
			});
		});
	</script>
