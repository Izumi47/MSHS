...
include 'php/teachers-profile.php'; // Include backend script for student details
?>
        ...
        ***********************************-->
        <div class="content-body">
			<div class="container-fluid">
				<form action="php/teachers-edit-student-profile.php" method="POST" id="editTeacherForm">
											...
											<div class="row">
												<div class="col-xl-6 col-sm-6">
													<div class="mb-3">
														...
														<input type="text" class="form-control" id="name" name="name" placeholder="<?php echo htmlspecialchars($userData['name'] ?? 'Name not available'); ?>">
													</div>
													...
													<div class="input-group mb-3 input-primary">
														...
														<input type="number" class="form-control" id="contact" name="contact" placeholder="<?php echo htmlspecialchars($userData['contact'] ?? 'Contact not available'); ?>">
													</div>
												</div>
												<div class="col-xl-6 col-sm-6">
													<label class="form-label text-primary">Email Adress <span class="required">*</span></label>
													<div class="input-group mb-3 input-primary">
														<input type="text" class="form-control" id="email" name="email" placeholder="<?php echo htmlspecialchars($userData['email'] ?? 'Email not available'); ?>">
														<span class="input-group-text border-0">@mshs.com</span>
													</div>

													<div class="mb-3">
														<label class="form-label text-primary">Birth Date <span class="required">*</span></label>
														<input type="date" class="form-control" id="birthdate" name="birthdate" placeholder="<?php echo htmlspecialchars($userData['birthdate'] ?? 'Birth Date not available'); ?>">
													</div>
												</div>
											</div>
										</div>
					...
					<div class="">
						<a href="teachers-profile.php" class="btn btn-outline-primary me-3" style="color:#E1E1E1E1">Cancel</a>
						<button class="btn btn-primary" type="submit" id="register-button">Edit Profile</button> <!--Send to add-student.php-->
					</div>
				</form>	
			</div>
		</div>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>Teacher profile edited successfully!</p>
				</div>
				<div class="modal-footer">
					<a href="teachers-profile.php"><button type="button" class="btn btn-primary">Continue</button></a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal fade" id="warningModal">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>Teacher profile edit was unsuccessfull!</p>
				</div>
				<div class="modal-footer">
	...
	<script>
		...
		$(document).ready(function () {
			...
			$('#editTeacherForm').submit(function (event) {
				...
				$.ajax({
					type: 'POST',
					url: 'php/users-edit-profile.php',
					data: $('#editTeacherForm').serialize(),
					success: function (response) {
						console.log(response); // Debugging
						if (response.trim() === 'User record updated successfully!') {
			...
			$("#editTeacherModal .btn-primary").click(function() {
