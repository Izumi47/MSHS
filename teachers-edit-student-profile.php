...
include 'php/teachers-student-profile.php'; // Include backend script for student details
?>
...
<body>
        ...
        ***********************************-->
        <div class="content-body">
			<div class="container-fluid">
				<form action="php/teachers-edit-student-profile.php" method="POST" id="editStudentForm">
										...
										<div class="col-xl-12 col-lg-8">
											<div class="row">
												<div class="col-xl-6 col-sm-6">
													<div class="mb-3">
														<label class="form-label text-primary">Full Name <span>*</span></label>
														<input type="text" class="form-control" id="name" name="name" placeholder="<?php echo htmlspecialchars($studentData['name'] ?? 'Name not available'); ?>" required>
													</div>
													...
													<div class="input-group mb-3 input-primary">
														...
														<input type="number" class="form-control" id="contact" name="contact" placeholder="<?php echo htmlspecialchars($studentData['contact'] ?? 'Contact not available'); ?>" required>
													</div>

													<label class="form-label text-primary">Email Adress <span class="required">*</span></label>
													<div class="input-group mb-3 input-primary">
														<input type="text" class="form-control" id="email" name="email" placeholder="<?php echo htmlspecialchars($studentData['email'] ?? 'Email not available'); ?>" required>
													...
													<div class="mb-3">
														...
														<input type="text" class="form-control" id="classroom" name="classroom" placeholder="<?php echo htmlspecialchars($studentData['classroom'] ?? 'Classroom not available'); ?>" required>
													</div>
												</div>
												<div class="col-xl-6 col-sm-6">
													<div class="mb-3">
														<label lass="form-label text-primary">Address <span class="required">*</span></label>
														<input type="text" class="form-control" id="address" name="address" placeholder="<?php echo htmlspecialchars($studentData['address'] ?? 'Address not available'); ?>" required>
													</div>
													
													<div class="mb-3">
														<label class="form-label text-primary">Interests <span class="required">*</span></label>
														<select multiple class="default-select form-control" id="interests" name="interests[]"  placeholder="<?php echo htmlspecialchars($studentData['Interests'] ?? 'Interests not available'); ?>" required>
													...
													<div class="mb-3">
														...
														<select class="default-select  form-control wide" id="ambition" name="ambition" placeholder="<?php echo htmlspecialchars($studentData['Ambition'] ?? 'Ambition not available'); ?>" required>
													...
													<div class="mb-3">
														<label class="form-label text-primary">Class Stream <span class="required">*</span></label>
														<input type="text" class="form-control" id="class_stream" name="class_stream" placeholder="<?php echo htmlspecialchars($studentData['class_stream'] ?? 'Class Stream not available'); ?>" required>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="row">
									<div class="col-xl-6 col-sm-6">
										<div class="mb-3">
											...
											<input type="text" class="form-control" id="CGPA" name="CGPA" placeholder="<?php echo htmlspecialchars($studentData['CGPA'] ?? 'CGPA not available'); ?>" required>
										</div>

										<div class="mb-3">
											<label class="form-label text-primary">Class Performance [Bahasa Melayu] <span class="required">*</span></label>
											<select class="default-select  form-control wide" id="bm" name="bm" placeholder="<?php echo htmlspecialchars($studentData['BM'] ?? 'BM not available'); ?>" required>
												<option>Bad</option>
												<option>Poor</option>
										...
										<div class="mb-3">
											...
											<select class="default-select  form-control wide" id="english" name="english" placeholder="<?php echo htmlspecialchars($studentData['English'] ?? 'English not available'); ?>" required>
												<option>Bad</option>
												<option>Poor</option>
												<option>Average</option>
												<option>Good</option>
										...
										<div class="mb-3">
											...
											<select class="default-select  form-control wide" id="sejarah" name="sejarah" placeholder="<?php echo htmlspecialchars($studentData['Sejarah'] ?? 'Sejarah not available'); ?>" required>
												<option>Bad</option>
												<option>Poor</option>
												<option>Average</option>
												<option>Good</option>
									...
									<div class="col-xl-6 col-sm-6">
										<div class="mb-3">
											<div class="mb-3">
												...
												<select class="default-select  form-control wide" id="maths" name="maths" placeholder="<?php echo htmlspecialchars($studentData['Maths'] ?? 'Mathematics not available'); ?>" required>
													<option>Bad</option>
													<option>Poor</option>
													<option>Average</option>
													<option>Good</option>
											...
											<div class="mb-3">
												...
												<select class="default-select  form-control wide" id="science" name="science" placeholder="<?php echo htmlspecialchars($studentData['Science'] ?? 'Science not available'); ?>" required>
													<option>Bad</option>
													<option>Poor</option>
													<option>Average</option>
													<option>Good</option>
					...
					<div class="">
						<a href="teachers-student-profile.php?id=<?php echo $studentId;?>" class="btn btn-outline-primary me-3" style="color:#E1E1E1E1">Cancel</a>
						<button class="btn btn-primary" type="submit" id="register-button">Edit Student Profile</button> <!--Send to add-student.php-->
					</div>
				</form>	
			</div>
		</div>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>Student profile editted successfully!</p>
				</div>
				<div class="modal-footer">
					<a href="teachers-student-profile.php?id=<?php echo $studentId; ?>"><button type="button" class="btn btn-primary">Continue</button></a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal fade" id="warningModal">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>Student profile edit was unsuccessfull!</p>
					<p>Make sure to fill all of the required fields.</p>
				</div>
				<div class="modal-footer">
    ...
    ***********************************-->
	...
	<script>
		...
		var studentId = "<?php echo isset($_GET['id']) ? $_GET['id'] : ''; ?>";

		// Set the studentId in the userId hidden input field
		$('#userId').val(studentId);

			$('#editStudentForm').submit(function (event) {
				event.preventDefault();
   				console.log('Form submitted'); // Add this line
				console.log($('#editStudentForm').serialize()); // Debugging
				$.ajax({
					type: 'POST',
					url: 'php/teachers-edit-student-profile.php',
					data: $('#editStudentForm').serialize(),
					success: function (response) {
						console.log(response); // Debugging
						if (response.trim() === 'Student record updated successfully!') {
