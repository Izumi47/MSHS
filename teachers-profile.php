								...
								<div class="d-flex justify-content-between">
									<div class="user">
										<div class="user-media">
											<img src="data:image/png;base64,<?php echo base64_encode($user_data["picture"]); ?>" alt="" class="avatar avatar-xxl">
										</div>
										<div>
									...
									<div class="dropdown custom-dropdown">
										...
										<div class="dropdown-menu dropdown-menu-end">
											<a class="dropdown-item" href="teachers-edit-profile.php">Edit Details</a>
										</div>
									</div>
								</div>
								<div class="row mt-2">
